---
name: intent-sentiment-mapping
description: Extracting customer operational frustration and technical urgency from unstructured tickets.
---
...
```json
{
  "skill": "intent-sentiment-mapping",
  "status": "completed",
  "confidence": 0.95,
  "findings": []
}
